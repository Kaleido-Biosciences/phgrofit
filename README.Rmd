...
**Input:**
1. Plate_Type : A specifically formatted .txt file resulting from an export of data using the biotek GEN5 software.
...
8. **Row (#x + 6 + number of timepoints + 1):** pH_Final, specifies that the measurements below are pH
